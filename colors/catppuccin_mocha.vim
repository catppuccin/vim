...
hi Normal           guisp=NONE      guifg=#C6D0F5   guibg=#1E1E2E   ctermfg=254     ctermbg=235  gui=NONE           cterm=NONE
hi Visual           guisp=NONE      guifg=NONE      guibg=#43465A   ctermfg=NONE    ctermbg=240  gui=bold           cterm=bold

hi Conceal          guisp=NONE      guifg=#7B819D   guibg=NONE      ctermfg=246     ctermbg=NONE gui=NONE           cterm=NONE
hi ColorColumn      guisp=NONE      guifg=NONE      guibg=#313244   ctermfg=NONE    ctermbg=236  gui=NONE           cterm=NONE
hi Cursor           guisp=NONE      guifg=#1E1E2E   guibg=#C6D0F5   ctermfg=235     ctermbg=254  gui=NONE           cterm=NONE
hi lCursor          guisp=NONE      guifg=#1E1E2E   guibg=#C6D0F5   ctermfg=235     ctermbg=254  gui=NONE           cterm=NONE
hi CursorIM         guisp=NONE      guifg=#1E1E2E   guibg=#C6D0F5   ctermfg=235     ctermbg=254  gui=NONE           cterm=NONE
...
hi Directory        guisp=NONE      guifg=#87B0F9   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
...
hi DiffText         guisp=NONE      guifg=#87B0F9   guibg=#1E1E2E   ctermfg=117     ctermbg=235  gui=NONE           cterm=NONE
...
hi Folded           guisp=NONE      guifg=#87B0F9   guibg=#43465A   ctermfg=117     ctermbg=240  gui=NONE           cterm=NONE
hi FoldColumn       guisp=NONE      guifg=#696D86   guibg=#1E1E2E   ctermfg=243     ctermbg=235  gui=NONE           cterm=NONE
hi SignColumn       guisp=NONE      guifg=#43465A   guibg=#1E1E2E   ctermfg=240     ctermbg=235  gui=NONE           cterm=NONE
hi IncSearch        guisp=NONE      guifg=#43465A   guibg=#F5C2E7   ctermfg=240     ctermbg=218  gui=NONE           cterm=NONE
hi LineNr           guisp=NONE      guifg=#43465A   guibg=NONE      ctermfg=240     ctermbg=NONE gui=NONE           cterm=NONE
...
hi MoreMsg          guisp=NONE      guifg=#87B0F9   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
hi NonText          guisp=NONE      guifg=#696D86   guibg=NONE      ctermfg=243     ctermbg=NONE gui=NONE           cterm=NONE
hi Pmenu            guisp=NONE      guifg=#8E95B3   guibg=#313244   ctermfg=251     ctermbg=236  gui=NONE           cterm=NONE
hi PmenuSel         guisp=NONE      guifg=#C6D0F5   guibg=#43465A   ctermfg=254     ctermbg=240  gui=bold           cterm=bold
hi PmenuSbar        guisp=NONE      guifg=NONE      guibg=#43465A   ctermfg=NONE    ctermbg=240  gui=NONE           cterm=NONE
hi PmenuThumb       guisp=NONE      guifg=NONE      guibg=#696D86   ctermfg=NONE    ctermbg=243  gui=NONE           cterm=NONE
hi Question         guisp=NONE      guifg=#87B0F9   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
hi QuickFixLine     guisp=NONE      guifg=NONE      guibg=#43465A   ctermfg=NONE    ctermbg=240  gui=bold           cterm=bold
hi Search           guisp=NONE      guifg=#F5C2E7   guibg=#43465A   ctermfg=218     ctermbg=240  gui=bold           cterm=bold
...
hi SpellLocal       guisp=#87B0F9   guifg=NONE      guibg=NONE      ctermfg=117     ctermbg=NONE gui=underline      cterm=underline
hi SpellRare        guisp=#A6E3A1   guifg=NONE      guibg=NONE      ctermfg=151     ctermbg=NONE gui=underline      cterm=underline
hi StatusLine       guisp=NONE      guifg=#C6D0F5   guibg=#181825   ctermfg=254     ctermbg=234  gui=NONE           cterm=NONE
hi StatusLineNC     guisp=NONE      guifg=#43465A   guibg=#181825   ctermfg=240     ctermbg=234  gui=NONE           cterm=NONE
...
hi TabLine          guisp=NONE      guifg=#43465A   guibg=#181825   ctermfg=240     ctermbg=234  gui=NONE           cterm=NONE
hi TabLineFill      guisp=NONE      guifg=NONE      guibg=#181825   ctermfg=NONE    ctermbg=234  gui=NONE           cterm=NONE
hi TabLineSel       guisp=NONE      guifg=#A6E3A1   guibg=#43465A   ctermfg=151     ctermbg=240  gui=NONE           cterm=NONE
hi Terminal         guisp=NONE      guifg=#ffffff   guibg=NONE      ctermfg=231     ctermbg=NONE gui=NONE           cterm=NONE
hi Title            guisp=NONE      guifg=#87B0F9   guibg=NONE      ctermfg=117     ctermbg=NONE gui=bold           cterm=bold
hi VisualNOS        guisp=NONE      guifg=NONE      guibg=#43465A   ctermfg=NONE    ctermbg=240  gui=bold           cterm=bold
hi WarningMsg       guisp=NONE      guifg=#F9E2AF   guibg=NONE      ctermfg=223     ctermbg=NONE gui=NONE           cterm=NONE
hi WildMenu         guisp=NONE      guifg=NONE      guibg=#696D86   ctermfg=NONE    ctermbg=243  gui=NONE           cterm=NONE
hi Comment          guisp=NONE      guifg=#565970   guibg=NONE      ctermfg=243     ctermbg=NONE gui=NONE           cterm=NONE
...
hi Type             guisp=NONE      guifg=#87B0F9   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
...
hi Function         guisp=NONE      guifg=#87B0F9   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
