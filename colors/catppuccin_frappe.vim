...
hi Normal           guisp=NONE      guifg=#C6CEEF   guibg=#303446   ctermfg=254     ctermbg=235  gui=NONE           cterm=NONE
hi Visual           guisp=NONE      guifg=NONE      guibg=#51566C   ctermfg=NONE    ctermbg=240  gui=bold           cterm=bold

hi Conceal          guisp=NONE      guifg=#838AA4   guibg=NONE      ctermfg=246     ctermbg=NONE gui=NONE           cterm=NONE
hi ColorColumn      guisp=NONE      guifg=NONE      guibg=#414559   ctermfg=NONE    ctermbg=236  gui=NONE           cterm=NONE
hi Cursor           guisp=NONE      guifg=#303446   guibg=#C6CEEF   ctermfg=235     ctermbg=254  gui=NONE           cterm=NONE
hi lCursor          guisp=NONE      guifg=#303446   guibg=#C6CEEF   ctermfg=235     ctermbg=254  gui=NONE           cterm=NONE
hi CursorIM         guisp=NONE      guifg=#303446   guibg=#C6CEEF   ctermfg=235     ctermbg=254  gui=NONE           cterm=NONE
...
hi Folded           guisp=NONE      guifg=#8CAAEE   guibg=#51566C   ctermfg=117     ctermbg=240  gui=NONE           cterm=NONE
hi FoldColumn       guisp=NONE      guifg=#737891   guibg=#303446   ctermfg=243     ctermbg=235  gui=NONE           cterm=NONE
hi SignColumn       guisp=NONE      guifg=#51566C   guibg=#303446   ctermfg=240     ctermbg=235  gui=NONE           cterm=NONE
hi IncSearch        guisp=NONE      guifg=#51566C   guibg=#F4B8E4   ctermfg=240     ctermbg=218  gui=NONE           cterm=NONE
hi LineNr           guisp=NONE      guifg=#51566C   guibg=NONE      ctermfg=240     ctermbg=NONE gui=NONE           cterm=NONE
...
hi ModeMsg          guisp=NONE      guifg=#C6CEEF   guibg=NONE      ctermfg=254     ctermbg=NONE gui=bold           cterm=bold
hi MoreMsg          guisp=NONE      guifg=#8CAAEE   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
hi NonText          guisp=NONE      guifg=#737891   guibg=NONE      ctermfg=243     ctermbg=NONE gui=NONE           cterm=NONE
hi Pmenu            guisp=NONE      guifg=#949BB7   guibg=#414559   ctermfg=251     ctermbg=236  gui=NONE           cterm=NONE
hi PmenuSel         guisp=NONE      guifg=#C6CEEF   guibg=#51566C   ctermfg=254     ctermbg=240  gui=bold           cterm=bold
hi PmenuSbar        guisp=NONE      guifg=NONE      guibg=#51566C   ctermfg=NONE    ctermbg=240  gui=NONE           cterm=NONE
hi PmenuThumb       guisp=NONE      guifg=NONE      guibg=#737891   ctermfg=NONE    ctermbg=243  gui=NONE           cterm=NONE
hi Question         guisp=NONE      guifg=#8CAAEE   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
hi QuickFixLine     guisp=NONE      guifg=NONE      guibg=#51566C   ctermfg=NONE    ctermbg=240  gui=bold           cterm=bold
hi Search           guisp=NONE      guifg=#F4B8E4   guibg=#51566C   ctermfg=218     ctermbg=240  gui=bold           cterm=bold
hi SpecialKey       guisp=NONE      guifg=#C6CEEF   guibg=NONE      ctermfg=254     ctermbg=NONE gui=NONE           cterm=NONE
...
hi StatusLine       guisp=NONE      guifg=#C6CEEF   guibg=#292C3C   ctermfg=254     ctermbg=234  gui=NONE           cterm=NONE
hi StatusLineNC     guisp=NONE      guifg=#51566C   guibg=#292C3C   ctermfg=240     ctermbg=234  gui=NONE           cterm=NONE
...
hi TabLine          guisp=NONE      guifg=#51566C   guibg=#292C3C   ctermfg=240     ctermbg=234  gui=NONE           cterm=NONE
hi TabLineFill      guisp=NONE      guifg=NONE      guibg=#292C3C   ctermfg=NONE    ctermbg=234  gui=NONE           cterm=NONE
hi TabLineSel       guisp=NONE      guifg=#A6D189   guibg=#51566C   ctermfg=151     ctermbg=240  gui=NONE           cterm=NONE
...
hi VisualNOS        guisp=NONE      guifg=NONE      guibg=#51566C   ctermfg=NONE    ctermbg=240  gui=bold           cterm=bold
hi WarningMsg       guisp=NONE      guifg=#E5C890   guibg=NONE      ctermfg=223     ctermbg=NONE gui=NONE           cterm=NONE
hi WildMenu         guisp=NONE      guifg=NONE      guibg=#737891   ctermfg=NONE    ctermbg=243  gui=NONE           cterm=NONE
